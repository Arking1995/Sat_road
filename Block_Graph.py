...
class BlockGraph(DiGraph):
    ...
    def __init__(self, blockID, population=None, elevation=None, lr_images=None, regionID=None, azimuth = None, width =None, height = None, offsetx = None, offsety = None, area = None):
